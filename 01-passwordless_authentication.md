...
** EC2 Instances **
- Create 2 EC2 instances in AWS (ubuntu)
  Create key-value pair pem file and stire it locally
...
`ssh ubuntu@<INSTANCE-PUBLIC-IP>`
  Connect to the EC2 instance(manage node) from your Ternminal (Control node)
